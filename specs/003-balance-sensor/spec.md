...
- **FR-013**: Failure log entries MUST include diagnostic context — the HTTP status code when available and any Vonage-provided request identifier when surfaced by the SDK — and MUST NOT include the API secret or other credential material.
